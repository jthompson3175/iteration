...
Helpful to know, but Jeff doesn't love it
...
l[[2]] #use 2 square brackets

mean(l$vec_numeric)
```

A dataframe is just a list wow!
...
#All elements of this list are vectors
...
This is fine, but still sucks a little:
